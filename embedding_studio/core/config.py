...
class Settings(BaseSettings):
    ...
    # PGSQL
    PGSQL_DATA_LOADER_ATTEMPTS: int = os.getenv(
        "PGSQL_DATA_LOADER_ATTEMPTS", DEFAULT_MAX_ATTEMPTS
    )
    PGSQL_DATA_LOADER_WAIT_TIME_SECONDS: float = os.getenv(
        "PGSQL_DATA_LOADER_WAIT_TIME_SECONDS", DEFAULT_WAIT_TIME_SECONDS
    )

    # HuggingFace
    MODEL_DOWNLOAD_MAX_ATTPEMPTS: int = os.getenv(
        "MODEL_DOWNLOAD_MAX_ATTPEMPTS", DEFAULT_MAX_ATTEMPTS
    )
    MODEL_DOWNLOAD_WAIT_TIME_SECONDS: float = os.getenv(
        "MODEL_DOWNLOAD_WAIT_TIME_SECONDS", DEFAULT_WAIT_TIME_SECONDS
    )
