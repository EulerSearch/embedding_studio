...
class Settings(BaseSettings):
    ...
    DEFAULT_WAIT_TIME_SECONDS: int = os.getenv("DEFAULT_WAIT_TIME_SECONDS", 3)

    # S3
    S3_READ_CREDENTIALS_ATTEMPTS: int = os.getenv(
        "S3_READ_CREDENTIALS_ATTEMPTS", DEFAULT_MAX_ATTEMPTS
    )
    S3_READ_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    S3_DOWNLOAD_DATA_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_LOG_METRIC_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_LOG_PARAM_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_LOG_MODEL_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_LOAD_MODEL_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_DELETE_MODEL_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_SEARCH_RUNS_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_END_RUN_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_GET_RUN_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_SEARCH_EXPERIMENTS_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_DELETE_EXPERIMENT_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_CREATE_EXPERIMENT_WAIT_TIME_SECONDS: int = os.getenv(
    ...
    MLFLOW_GET_EXPERIMENT_WAIT_TIME_SECONDS: int = os.getenv(
